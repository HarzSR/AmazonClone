                        ...
                        <div class="body">
                            <form id="form_validation" id="adminPasswordUpdate" name="adminPasswordUpdate" method="POST" action="{{ url('admin/password') }}">
                                ...
                                <div class="btn-group-lg align-right">
                                    <button class="btn btn-danger waves-effect align-right" type="reset">RESET</button>
                                    <button class="btn btn-primary waves-effect align-right" type="submit">SUBMIT</button>
                                </div>
                            </form>
                        </div>
                    </div>
